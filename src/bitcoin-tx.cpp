...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jbcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jbcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jbcoin transaction") + "\n" +
              "  jbcoin-tx [options] -create [commands]   " + _("Create hex-encoded jbcoin transaction") + "\n" +
              "\n";
